...
if (!isset($_GET['author_uuid'])) {
    header('Location: authors.php?message=' . urlencode('Auteur non spécifié.') . '&type=warning');
    exit();
}
...
if (!$author) {
    header('Location: authors.php?message=' . urlencode('Auteur non trouvé.') . '&type=warning');
    exit();
}
?>
<div class="main-container pb-5 mt-3">
    <div class="col-md-12 col-sm-12 mb-3">
        <?php include("process_edit_authors.php") ?>  
    ...
    <div class="d-flex justify-content-between gap-2 flex-column flex-lg-row">
        <h4 class="h3 mb-0 text-gray-800 text-uppercase fw-bold">Modifier un auteur</h4>
    </div>
            ...
            <div class="row mt-3">
                <div class="col-lg-6 col-sm-12 mb-3">
                    <div class="mb-3">
                        ...
                        value="<?= htmlspecialchars($author['author_full_name']) ?>">
                    ...
                    <div class="mb-3">
                        ...
                        value="<?= htmlspecialchars($author['author_email']) ?>">
                        <div class="invalid-feedback">
                            Ce champ est requis !
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        value="<?= htmlspecialchars($author['author_nationality']) ?>">
                        <div class="invalid-feedback">
                            Ce champ est requis !
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-sm-12 mb-3">
                    <div class="mb-3">
                        ...
                        value="<?= htmlspecialchars($author['author_phone_number']) ?>">
                        <div class="invalid-feedback">
                            Ce champ est requis !
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        value="<?= htmlspecialchars($author['author_second_phone_number']) ?>">
                    </div>
                    <div class="mb-3">
